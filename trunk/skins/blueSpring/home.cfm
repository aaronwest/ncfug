<cfoutput>
	...
	<h1>Welcome to the Capitol Hill User Group</h1>
	<p>
		The Capitol Hill User Group (CHUG) is an <a href="http://www.adobe.com/cfusion/usergroups/index.cfm">Adobe User Group</a> 
		for U.S. Federal Government web developers who use or are interested in using Adobe web development technologies. This group 
		does not focus on the Adobe creative products such as Photoshop, but is focused on programming tools and languages such as 
		<a href="http://www.adobe.com/products/coldfusion/">ColdFusion</a>, <a href="http://www.adobe.com/products/flex/">Flex</a>, and 
		<a href="http://www.adobe.com/go/air/">AIR</a>. We cover a variety of topics and skill levels, so please join us!
	</p>
	
	<p>
		We will also discuss general "best practice" topics in web development and will delve into topics such as object-oriented 
		development, frameworks, and ways to improve your development processes for safer, better coding.  If you're interested in hearing 
		about a particular topic, or you're interested in presenting, please 
		<a href="index.cfm?#getProperty('eventParameter')#=showContactForm">fill out our contact form</a>.
	</p>
	
	<h1>#getProperty("resourceBundleService").getResourceBundle().getResource("nextmeeting")#</h1>
	
	<cfif isDefined("nextMeeting")>
		<h3>
			<a href="index.cfm?event=showMeeting&meetingID=#nextMeeting.getMeetingID()#">#nextMeeting.getTitle()#</a><br />
			#getProperty("resourceBundleService").getLocaleUtils().i18nDateTimeFormat(nextMeeting.getDTMeeting(), 3, 3)#<br />
		...
		<p>
			<a href="index.cfm?#getProperty('eventParameter')#=showRSVPForm&meetingID=#nextMeeting.getMeetingID()#">
