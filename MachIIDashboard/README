...
Version: 1.0.0.1125
Built-on: 2008-10-27 15:53:15
$Id: README 1125 2008-10-26 23:54:40Z peterfarrell $
------------------------------------------------
...
web-applications.  Current functionality of the dashboard:
 ...
 - Reload base application or individual Mach-II modules
 - Reload base ColdSpring bean factory or individual child factories
 - Manage logging
 - Manage caching including charts of cache performance
 - Basic CFML engine and Mach-II framework configuration information
...
the Apache License:
Copyright 2008 GreatBizTools, LLC All rights reserved.
----
...
4.	Reload your Mach-II application and navigate to:
	...
	http://www.example.com/index.cfm?go=dashboard:config.index
