...
$Id: basic.cfm 1077 2008-09-22 18:52:43Z peterfarrell $
...
h1 { font-size: 150%; margin: 0; color: ##000; }
...
##content div.error {
	...
	background: ##FFF url(#BuildUrl("sys.serveAsset", "path=@img@icons@information.png")#) left center no-repeat;
}
