...
$Id: Udfs.cfc 1105 2008-10-20 04:45:45Z peterfarrell $
...
<cfcomponent
	...
	<cffunction name="getCFCDocUrl" access="public" returntype="string" output="false">
		...
		<cfreturn "http://www.mach-ii.com/cfcdocs/" & version & "/" & package & "/" & component & ".html" />
	</cffunction>
	...
	<cffunction name="byteConvert" access="public" returntype="string" output="false"> 
		...
		<cfscript>
		//function byteConvert(num, addMBString) {
		   var result = 0;
