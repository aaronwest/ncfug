...
<cfcomponent
	...
	<cffunction name="enableDisableAll" access="public" returntype="void" output="false"
		...
		<cfif mode EQ "enable">
			<cfset arguments.event.setArg("message", "Enabled all cache strategies.") />
		<cfelse>
			<cfset arguments.event.setArg("message", "Disabled all cache strategies.") />
		</cfif>
	</cffunction>
	...
	<cffunction name="reapAll" access="public" returntype="void" output="false"
		...
		<cfset arguments.event.setArg("message", "Reaped all cache strategies.") />
	</cffunction>
	...
	<cffunction name="flushAll" access="public" returntype="void" output="false"
		...
		<cfset arguments.event.setArg("message", "Flushed all cache strategies.") />
	</cffunction>
	...
	<cffunction name="enableDisableCacheStrategy" access="public" returntype="void" output="false"
		...
		<cfif mode EQ "enable">
			...
			<cfset arguments.event.setArg("message", "Enabled '#strategyName#'.") />
		<cfelse>
			<cfset cacheStrategy.setCacheEnabled(false) />
			<cfset arguments.event.setArg("message", "Disabled '#strategyName#'.") />
		</cfif>
	</cffunction>
	...
	<cffunction name="reapCacheStrategy" access="public" returntype="void" output="false"
		...
		<cfset arguments.event.setArg("message", "Reaped '#strategyName#'.") />
	</cffunction>
	...
	<cffunction name="flushCacheStrategy" access="public" returntype="void" output="false"
		...
		<cfset arguments.event.setArg("message", "Flushed '#strategyName#'.") />
	</cffunction>
	...
	<cffunction name="getCacheStrategyByModuleAndStrategyName" access="private" returntype="any" output="false"
		...
		<cfelse>
			<cfset cacheStrategyManager = getAppManager().getModuleManager().getModule(arguments.moduleName).getAppManager().getCacheManager().getCacheStrategyManager() />
		</cfif>
