...
<mach-ii version="1.0">
	...
	<properties>
		...
		<property name="siteName" value="Cleveland Adobe Users Group" />
		<property name="adminEmail" value="admin@clevelandaug.org" />
		<property name="contactName" value="Michael Cooper" />
		<property name="contactEmail" value="info@clevelandaug.org" />
		<property name="notificationFromAddress" value="admin@clevelandaug.org" />
		<property name="baseURL" value="http://www.clevelandaug.org" />
		...
		<property name="skin" value="Stylized" />
		<property name="rbFile" value="/i18n/main" />
		<property name="rbLocale" value="en_US" />
		<property name="copyrightNotice" value="Copyright 2007 Cleveland AUG" />
		...
		<property name="mailServer" value="mail.clevelandaug.org" />
		<!-- coldspring related -->
