...
<mach-ii version="1.0">
	...
	<properties>
		...
		<property name="dsn" value="chug" />
		<property name="dbType" value="MySQL" />
		<property name="dbUserName" value="root" />
		<property name="dbPassword" value="password" />
		<property name="devMode" value="true" />
		<property name="numPreviousMeetingItems" value="10" />
		<property name="numUpcomingMeetingItems" value="1" />
		<property name="numPublicNewsItems" value="3" />
		<property name="siteName" value="Cleveland ColdFusion User Group" />
		<property name="adminEmail" value="admin@clevelandcfug.com" />
		<property name="contactName" value="Brian Meloche" />
		<property name="contactEmail" value="info@clevelandcfug.com" />
		<property name="notificationFromAddress" value="admin@clevelandcfug.com" />
		<property name="baseURL" value="http://www.clevelandcfug.com" />
		...
		<property name="skin" value="bluePigment" />
		<property name="rbFile" value="/i18n/main" />
		<property name="rbLocale" value="en_US" />
		<property name="copyrightNotice" value="Copyright 2007 Cleveland CFUG" />
		<property name="defaultState" value="OH" />
		<property name="defaultStateName" value="Ohio" />
		<property name="defaultCountry" value="US" />
		<property name="defaultCountryName" value="United States" />
		<!-- mail/server config related -->
		<property name="mailServer" value="mail.clevelandcfug.org" />
		<!-- coldspring related -->
